...
import { H1, H3, H4, Paragraph, Small } from "../../components/Common/Typography";
...
const Pricing = () => {
  return (
    <Container>
      <StyledCard>
        <H4 color="primary.main">You are using the free version of the Application</H4>
...
const planList = [
  { title: "General", price: 75, logo: "/assets/images/illustrations/baby.svg" },
  { title: "Docotr", price: 195, logo: "/assets/images/illustrations/upgrade.svg" },
  { title: "Customer", price: 495, logo: "/assets/images/illustrations/business_deal.svg" },
];
